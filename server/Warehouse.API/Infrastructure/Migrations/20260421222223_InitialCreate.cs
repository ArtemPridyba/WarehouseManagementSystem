        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryBalances_Batches_BatchId",
                        column: x => x.BatchId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryBalances_BatchId",
                table: "InventoryBalances",
                column: "BatchId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryBalances_LocationId_ProductId_BatchId",
                table: "InventoryBalances",
                columns: new[] { "LocationId", "ProductId", "BatchId" },
                unique: true);
