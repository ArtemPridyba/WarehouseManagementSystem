...
namespace Warehouse.API.Infrastructure.Migrations
{
    ...
    [Migration("20260516113830_AddManagerRoleAndCreatedByUserId")]
    partial class AddManagerRoleAndCreatedByUserId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Warehouse.API.Domain.Entities.InventoryTransaction", b =>
                {
                    ...
                    b.HasOne("Warehouse.API.Domain.Entities.AppUser", "CreatedByUser")
                        .WithMany()
